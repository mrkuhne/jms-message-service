...
public class MessageSenderService {
    ...
    private void messageEmitter() {
        jmsTemplate.convertAndSend(jmsTopicConfig.getPriceInfoTopicDestinationFree(),
            messageCreator("Message", "Free", randomBigDecimal()));
        jmsTemplate.convertAndSend(jmsTopicConfig.getPrinceInfoTopicDestinationPremium(),
